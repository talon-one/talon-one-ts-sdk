...
`rewardId` | number
`props` | [RedeemReferralEffectProps](RedeemReferralEffectProps.md)

## Example

```typescript
import type { EffectRedeemReferral } from 'talon_one_sdk'
...
const example = {
  ...
  "rewardId": 7,
  "props": null,
} satisfies EffectRedeemReferral
...
const exampleParsed = JSON.parse(exampleJSON) as EffectRedeemReferral
