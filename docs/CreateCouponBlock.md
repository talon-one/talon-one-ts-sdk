...
`usageLimit` | [CreateCouponBlock1UsageLimit](CreateCouponBlock1UsageLimit.md)
...
```typescript
import type { CreateCouponBlock } from 'talon_one_sdk'
...
const exampleParsed = JSON.parse(exampleJSON) as CreateCouponBlock
