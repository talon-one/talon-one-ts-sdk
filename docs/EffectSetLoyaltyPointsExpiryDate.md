...
`rewardId` | number
`props` | [SetLoyaltyPointsExpiryDateEffectProps](SetLoyaltyPointsExpiryDateEffectProps.md)

## Example

```typescript
import type { EffectSetLoyaltyPointsExpiryDate } from 'talon_one_sdk'
...
const example = {
  ...
  "rewardId": 7,
  "props": null,
} satisfies EffectSetLoyaltyPointsExpiryDate
...
const exampleParsed = JSON.parse(exampleJSON) as EffectSetLoyaltyPointsExpiryDate
