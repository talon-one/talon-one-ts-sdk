...
`rewardId` | number
`props` | [RollbackAddedLoyaltyPointsEffectProps](RollbackAddedLoyaltyPointsEffectProps.md)

## Example

```typescript
import type { EffectRollbackAddedLoyaltyPoints } from 'talon_one_sdk'
...
const example = {
  ...
  "rewardId": 7,
  "props": null,
} satisfies EffectRollbackAddedLoyaltyPoints
...
const exampleParsed = JSON.parse(exampleJSON) as EffectRollbackAddedLoyaltyPoints
