...
`rewardId` | number
`props` | [SetDiscountPerAdditionalCostEffectProps](SetDiscountPerAdditionalCostEffectProps.md)

## Example

```typescript
import type { EffectSetDiscountPerAdditionalCost } from 'talon_one_sdk'
...
const example = {
  ...
  "rewardId": 7,
  "props": null,
} satisfies EffectSetDiscountPerAdditionalCost
...
const exampleParsed = JSON.parse(exampleJSON) as EffectSetDiscountPerAdditionalCost
