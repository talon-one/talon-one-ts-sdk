...
`rewardId` | number
`props` | [AddToAudienceEffectProps](AddToAudienceEffectProps.md)

## Example

```typescript
import type { EffectAddToAudience } from 'talon_one_sdk'
...
const exampleParsed = JSON.parse(exampleJSON) as EffectAddToAudience
