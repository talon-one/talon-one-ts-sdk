...
`rewardId` | number
`props` | [SetDiscountEffectProps](SetDiscountEffectProps.md)

## Example

```typescript
import type { EffectSetDiscount } from 'talon_one_sdk'
...
const exampleParsed = JSON.parse(exampleJSON) as EffectSetDiscount
