...
`rewardId` | number
`props` | [UnlockRewardEffectProps](UnlockRewardEffectProps.md)

## Example

```typescript
import type { EffectUnlockReward } from 'talon_one_sdk'
...
const exampleParsed = JSON.parse(exampleJSON) as EffectUnlockReward
