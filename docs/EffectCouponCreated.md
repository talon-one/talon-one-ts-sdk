...
`rewardId` | number
`props` | [CouponCreatedEffectProps](CouponCreatedEffectProps.md)

## Example

```typescript
import type { EffectCouponCreated } from 'talon_one_sdk'
...
const exampleParsed = JSON.parse(exampleJSON) as EffectCouponCreated
