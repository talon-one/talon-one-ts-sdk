...
`rewardId` | number
`props` | [ExtendLoyaltyPointsExpiryDateEffectProps](ExtendLoyaltyPointsExpiryDateEffectProps.md)

## Example

```typescript
import type { EffectExtendLoyaltyPointsExpiryDate } from 'talon_one_sdk'
...
const example = {
  ...
  "rewardId": 7,
  "props": null,
} satisfies EffectExtendLoyaltyPointsExpiryDate
...
const exampleParsed = JSON.parse(exampleJSON) as EffectExtendLoyaltyPointsExpiryDate
