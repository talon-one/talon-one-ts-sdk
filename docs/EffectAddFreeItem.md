...
`rewardId` | number
`props` | [AddFreeItemEffectProps](AddFreeItemEffectProps.md)

## Example

```typescript
import type { EffectAddFreeItem } from 'talon_one_sdk'
...
const exampleParsed = JSON.parse(exampleJSON) as EffectAddFreeItem
