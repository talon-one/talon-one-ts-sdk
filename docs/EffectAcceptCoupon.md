...
`rewardId` | number
`props` | [AcceptCouponEffectProps](AcceptCouponEffectProps.md)

## Example

```typescript
import type { EffectAcceptCoupon } from 'talon_one_sdk'
...
const exampleParsed = JSON.parse(exampleJSON) as EffectAcceptCoupon
