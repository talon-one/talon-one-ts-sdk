...
`rewardId` | number
`props` | [IncreaseAchievementProgressEffectProps](IncreaseAchievementProgressEffectProps.md)

## Example

```typescript
import type { EffectIncreaseAchievementProgress } from 'talon_one_sdk'
...
const example = {
  ...
  "rewardId": 7,
  "props": null,
} satisfies EffectIncreaseAchievementProgress
...
const exampleParsed = JSON.parse(exampleJSON) as EffectIncreaseAchievementProgress
