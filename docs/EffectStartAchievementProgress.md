...
`rewardId` | number
`props` | [StartAchievementProgressEffectProps](StartAchievementProgressEffectProps.md)

## Example

```typescript
import type { EffectStartAchievementProgress } from 'talon_one_sdk'
...
const example = {
  ...
  "rewardId": 7,
  "props": null,
} satisfies EffectStartAchievementProgress
...
const exampleParsed = JSON.parse(exampleJSON) as EffectStartAchievementProgress
