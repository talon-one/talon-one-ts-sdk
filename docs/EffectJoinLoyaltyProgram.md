...
`rewardId` | number
`props` | [JoinLoyaltyProgramEffectProps](JoinLoyaltyProgramEffectProps.md)

## Example

```typescript
import type { EffectJoinLoyaltyProgram } from 'talon_one_sdk'
...
const example = {
  ...
  "rewardId": 7,
  "props": null,
} satisfies EffectJoinLoyaltyProgram
...
const exampleParsed = JSON.parse(exampleJSON) as EffectJoinLoyaltyProgram
