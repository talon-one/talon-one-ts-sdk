...
`reservations` | [Array&lt;CouponReservation&gt;](CouponReservation.md)

## Example

```typescript
import type { CouponWithReservations } from 'talon_one_sdk'
...
const example = {
  ...
  "reservations": null,
} satisfies CouponWithReservations
...
const exampleParsed = JSON.parse(exampleJSON) as CouponWithReservations
