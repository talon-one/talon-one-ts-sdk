...
```typescript
import type { AudienceCustomer } from 'talon_one_sdk'
...
const example = {
  ...
  "sandbox": false,
  "connectedApplicationsIds": [1,2,3],
  "connectedAudiences": [1,2,3],
} satisfies AudienceCustomer
...
const exampleParsed = JSON.parse(exampleJSON) as AudienceCustomer
