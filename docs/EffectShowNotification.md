...
`rewardId` | number
`props` | [ShowNotificationEffectProps](ShowNotificationEffectProps.md)

## Example

```typescript
import type { EffectShowNotification } from 'talon_one_sdk'
...
const example = {
  ...
  "rewardId": 7,
  "props": null,
} satisfies EffectShowNotification
...
const exampleParsed = JSON.parse(exampleJSON) as EffectShowNotification
