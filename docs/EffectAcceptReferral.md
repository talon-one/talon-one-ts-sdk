...
`rewardId` | number
`props` | [AcceptReferralEffectProps](AcceptReferralEffectProps.md)

## Example

```typescript
import type { EffectAcceptReferral } from 'talon_one_sdk'
...
const example = {
  ...
  "rewardId": 7,
  "props": null,
} satisfies EffectAcceptReferral
...
const exampleParsed = JSON.parse(exampleJSON) as EffectAcceptReferral
