...
```typescript
import type { EffectOffsetNegativeLoyaltyPoints } from 'talon_one_sdk'
...
const example = {
  ...
  "rewardId": 7,
} satisfies EffectOffsetNegativeLoyaltyPoints
...
const exampleParsed = JSON.parse(exampleJSON) as EffectOffsetNegativeLoyaltyPoints
