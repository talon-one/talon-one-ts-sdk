...
```typescript
import type { CreateCouponBlock1UsageLimit } from 'talon_one_sdk'

// TODO: Update the object below with actual values
const example = {
} satisfies CreateCouponBlock1UsageLimit
...
const exampleParsed = JSON.parse(exampleJSON) as CreateCouponBlock1UsageLimit
