...
`rewardId` | number
`props` | [ChangeLoyaltyTierLevelEffectProps](ChangeLoyaltyTierLevelEffectProps.md)

## Example

```typescript
import type { EffectChangeLoyaltyTierLevel } from 'talon_one_sdk'
...
const example = {
  ...
  "rewardId": 7,
  "props": null,
} satisfies EffectChangeLoyaltyTierLevel
...
const exampleParsed = JSON.parse(exampleJSON) as EffectChangeLoyaltyTierLevel
