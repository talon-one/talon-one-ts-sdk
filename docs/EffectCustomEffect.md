...
`rewardId` | number
`props` | [CustomEffectProps](CustomEffectProps.md)

## Example

```typescript
import type { EffectCustomEffect } from 'talon_one_sdk'
...
const exampleParsed = JSON.parse(exampleJSON) as EffectCustomEffect
