...
```typescript
import type { CouponWithApplication } from 'talon_one_sdk'
...
} satisfies CouponWithApplication
...
const exampleParsed = JSON.parse(exampleJSON) as CouponWithApplication
