...
`rewardId` | number
`props` | [DeductLoyaltyPointsEffectProps](DeductLoyaltyPointsEffectProps.md)

## Example

```typescript
import type { EffectDeductLoyaltyPoints } from 'talon_one_sdk'
...
const example = {
  ...
  "rewardId": 7,
  "props": null,
} satisfies EffectDeductLoyaltyPoints
...
const exampleParsed = JSON.parse(exampleJSON) as EffectDeductLoyaltyPoints
