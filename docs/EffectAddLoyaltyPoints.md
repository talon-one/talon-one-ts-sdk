...
`rewardId` | number
`props` | [AddLoyaltyPointsEffectProps](AddLoyaltyPointsEffectProps.md)

## Example

```typescript
import type { EffectAddLoyaltyPoints } from 'talon_one_sdk'
...
const example = {
  ...
  "rewardId": 7,
  "props": null,
} satisfies EffectAddLoyaltyPoints
...
const exampleParsed = JSON.parse(exampleJSON) as EffectAddLoyaltyPoints
