...
`rewardId` | number
`props` | [SetDiscountPerItemEffectProps](SetDiscountPerItemEffectProps.md)

## Example

```typescript
import type { EffectSetDiscountPerItem } from 'talon_one_sdk'
...
const example = {
  ...
  "rewardId": 7,
  "props": null,
} satisfies EffectSetDiscountPerItem
...
const exampleParsed = JSON.parse(exampleJSON) as EffectSetDiscountPerItem
