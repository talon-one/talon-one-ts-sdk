...
`rewardId` | number
`props` | [TriggerWebhookEffectProps](TriggerWebhookEffectProps.md)

## Example

```typescript
import type { EffectCallApi } from 'talon_one_sdk'
...
const exampleParsed = JSON.parse(exampleJSON) as EffectCallApi
