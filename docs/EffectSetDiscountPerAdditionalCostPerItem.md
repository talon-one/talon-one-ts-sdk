...
`rewardId` | number
`props` | [SetDiscountPerAdditionalCostPerItemEffectProps](SetDiscountPerAdditionalCostPerItemEffectProps.md)

## Example

```typescript
import type { EffectSetDiscountPerAdditionalCostPerItem } from 'talon_one_sdk'
...
const example = {
  ...
  "rewardId": 7,
  "props": null,
} satisfies EffectSetDiscountPerAdditionalCostPerItem
...
const exampleParsed = JSON.parse(exampleJSON) as EffectSetDiscountPerAdditionalCostPerItem
