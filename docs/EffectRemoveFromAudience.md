...
`rewardId` | number
`props` | [RemoveFromAudienceEffectProps](RemoveFromAudienceEffectProps.md)

## Example

```typescript
import type { EffectRemoveFromAudience } from 'talon_one_sdk'
...
const example = {
  ...
  "rewardId": 7,
  "props": null,
} satisfies EffectRemoveFromAudience
...
const exampleParsed = JSON.parse(exampleJSON) as EffectRemoveFromAudience
