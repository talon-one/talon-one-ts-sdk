...
`rewardId` | number
`props` | [ErrorEffectProps](ErrorEffectProps.md)

## Example

```typescript
import type { EffectError } from 'talon_one_sdk'
...
const exampleParsed = JSON.parse(exampleJSON) as EffectError
