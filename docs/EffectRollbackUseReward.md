...
`rewardId` | number
`props` | [RollbackUseRewardEffectProps](RollbackUseRewardEffectProps.md)

## Example

```typescript
import type { EffectRollbackUseReward } from 'talon_one_sdk'
...
const example = {
  ...
  "rewardId": 7,
  "props": null,
} satisfies EffectRollbackUseReward
...
const exampleParsed = JSON.parse(exampleJSON) as EffectRollbackUseReward
