...
`rewardId` | number
`props` | [RollbackReferralEffectProps](RollbackReferralEffectProps.md)

## Example

```typescript
import type { EffectRollbackReferral } from 'talon_one_sdk'
...
const example = {
  ...
  "rewardId": 7,
  "props": null,
} satisfies EffectRollbackReferral
...
const exampleParsed = JSON.parse(exampleJSON) as EffectRollbackReferral
