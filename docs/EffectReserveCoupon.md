...
`rewardId` | number
`props` | [ReserveCouponEffectProps](ReserveCouponEffectProps.md)

## Example

```typescript
import type { EffectReserveCoupon } from 'talon_one_sdk'
...
const exampleParsed = JSON.parse(exampleJSON) as EffectReserveCoupon
