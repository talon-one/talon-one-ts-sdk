...
```typescript
import type { CustomerProfileIntegrationResponseV2 } from 'talon_one_sdk'
...
} satisfies CustomerProfileIntegrationResponseV2
...
const exampleParsed = JSON.parse(exampleJSON) as CustomerProfileIntegrationResponseV2
