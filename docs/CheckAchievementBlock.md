...
```typescript
import type { CheckAchievementBlock } from 'talon_one_sdk'
...
const example = {
  ...
  "achievement": null,
  "onFailure": null,
} satisfies CheckAchievementBlock
...
const exampleParsed = JSON.parse(exampleJSON) as CheckAchievementBlock
