...
`rewardId` | number
`props` | [UseRewardEffectProps](UseRewardEffectProps.md)

## Example

```typescript
import type { EffectUseReward } from 'talon_one_sdk'
...
const exampleParsed = JSON.parse(exampleJSON) as EffectUseReward
