...
`rewardId` | number
`props` | [RollbackDiscountEffectProps](RollbackDiscountEffectProps.md)

## Example

```typescript
import type { EffectRollbackDiscount } from 'talon_one_sdk'
...
const example = {
  ...
  "rewardId": 7,
  "props": null,
} satisfies EffectRollbackDiscount
...
const exampleParsed = JSON.parse(exampleJSON) as EffectRollbackDiscount
