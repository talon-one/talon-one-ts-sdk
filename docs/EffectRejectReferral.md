...
`rewardId` | number
`props` | [RejectReferralEffectProps](RejectReferralEffectProps.md)

## Example

```typescript
import type { EffectRejectReferral } from 'talon_one_sdk'
...
const example = {
  ...
  "rewardId": 7,
  "props": null,
} satisfies EffectRejectReferral
...
const exampleParsed = JSON.parse(exampleJSON) as EffectRejectReferral
