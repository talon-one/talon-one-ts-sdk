...
`rewardId` | number
`props` | [RollbackDeductedLoyaltyPointsEffectProps](RollbackDeductedLoyaltyPointsEffectProps.md)

## Example

```typescript
import type { EffectRollbackDeductedLoyaltyPoints } from 'talon_one_sdk'
...
const example = {
  ...
  "rewardId": 7,
  "props": null,
} satisfies EffectRollbackDeductedLoyaltyPoints
...
const exampleParsed = JSON.parse(exampleJSON) as EffectRollbackDeductedLoyaltyPoints
