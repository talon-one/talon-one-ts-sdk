...
`rewardId` | number
`props` | [UpdateAttributeEffectProps](UpdateAttributeEffectProps.md)

## Example

```typescript
import type { EffectSet } from 'talon_one_sdk'
...
const exampleParsed = JSON.parse(exampleJSON) as EffectSet
