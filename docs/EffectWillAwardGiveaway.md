...
```typescript
import type { EffectWillAwardGiveaway } from 'talon_one_sdk'
...
const example = {
  ...
  "rewardId": 7,
  "props": null,
} satisfies EffectWillAwardGiveaway
...
const exampleParsed = JSON.parse(exampleJSON) as EffectWillAwardGiveaway
