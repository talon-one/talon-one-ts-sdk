...
`rewardId` | number
`props` | [AwardGiveawayEffectProps](AwardGiveawayEffectProps.md)

## Example

```typescript
import type { EffectAwardGiveaway } from 'talon_one_sdk'
...
const exampleParsed = JSON.parse(exampleJSON) as EffectAwardGiveaway
