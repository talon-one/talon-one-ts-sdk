...
`rewardId` | number
`props` | [RollbackCouponEffectProps](RollbackCouponEffectProps.md)

## Example

```typescript
import type { EffectRollbackCoupon } from 'talon_one_sdk'
...
const example = {
  ...
  "rewardId": 7,
  "props": null,
} satisfies EffectRollbackCoupon
...
const exampleParsed = JSON.parse(exampleJSON) as EffectRollbackCoupon
