 ...
 * 
 * @export
 * @interface EffectOffsetNegativeLoyaltyPoints
 */
export interface EffectOffsetNegativeLoyaltyPoints {
    /**
     ...
     */
    effectType: EffectOffsetNegativeLoyaltyPointsEffectTypeEnum;
    /**
 ...
 * @export
 */
export const EffectOffsetNegativeLoyaltyPointsEffectTypeEnum = {
    OffsetNegativeLoyaltyPoints: 'offsetNegativeLoyaltyPoints',
} as const;
export type EffectOffsetNegativeLoyaltyPointsEffectTypeEnum = typeof EffectOffsetNegativeLoyaltyPointsEffectTypeEnum[keyof typeof EffectOffsetNegativeLoyaltyPointsEffectTypeEnum];


/**
 * Check if a given object implements the EffectOffsetNegativeLoyaltyPoints interface.
 */
export function instanceOfEffectOffsetNegativeLoyaltyPoints(value: object): value is EffectOffsetNegativeLoyaltyPoints {
    ...
    if (_v['effectType'] !== 'offsetNegativeLoyaltyPoints') return false;
    
    return true;
}

export function EffectOffsetNegativeLoyaltyPointsFromJSON(json: any): EffectOffsetNegativeLoyaltyPoints {
    return EffectOffsetNegativeLoyaltyPointsFromJSONTyped(json, false);
}

export function EffectOffsetNegativeLoyaltyPointsFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectOffsetNegativeLoyaltyPoints {
    if (json == null) {
        return json;
    }
    return {
...
export function EffectOffsetNegativeLoyaltyPointsToJSON(json: any): EffectOffsetNegativeLoyaltyPoints {
    return EffectOffsetNegativeLoyaltyPointsToJSONTyped(json, false);
}

export function EffectOffsetNegativeLoyaltyPointsToJSONTyped(value?: EffectOffsetNegativeLoyaltyPoints | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
