...
import {
    ...
    RollbackReferralEffectPropsToJSONTyped,
} from './RollbackReferralEffectProps';

/**
 * 
 * @export
 * @interface EffectRollbackReferral
 */
export interface EffectRollbackReferral {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `rollbackReferral`.
     */
    effectType: EffectRollbackReferralEffectTypeEnum;
    /**
    ...
    rewardId?: number;
    /**
     * The properties of the `rollbackReferral` effect.
     */
    props: RollbackReferralEffectProps;
}
 ...
 * @export
 */
export const EffectRollbackReferralEffectTypeEnum = {
    RollbackReferral: 'rollbackReferral',
} as const;
export type EffectRollbackReferralEffectTypeEnum = typeof EffectRollbackReferralEffectTypeEnum[keyof typeof EffectRollbackReferralEffectTypeEnum];


/**
 * Check if a given object implements the EffectRollbackReferral interface.
 */
export function instanceOfEffectRollbackReferral(value: object): value is EffectRollbackReferral {
    ...
    if (_v['effectType'] !== 'rollbackReferral') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectRollbackReferralFromJSON(json: any): EffectRollbackReferral {
    return EffectRollbackReferralFromJSONTyped(json, false);
}

export function EffectRollbackReferralFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectRollbackReferral {
    if (json == null) {
        return json;
    }
    return {
        ...
        'props': RollbackReferralEffectPropsFromJSON(json['props']),
    };
}

export function EffectRollbackReferralToJSON(json: any): EffectRollbackReferral {
    return EffectRollbackReferralToJSONTyped(json, false);
}

export function EffectRollbackReferralToJSONTyped(value?: EffectRollbackReferral | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'props': RollbackReferralEffectPropsToJSON(value['props']),
    };
}
