...
import {
    ...
    RollbackDeductedLoyaltyPointsEffectPropsToJSONTyped,
} from './RollbackDeductedLoyaltyPointsEffectProps';

/**
 * 
 * @export
 * @interface EffectRollbackDeductedLoyaltyPoints
 */
export interface EffectRollbackDeductedLoyaltyPoints {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `rollbackDeductedLoyaltyPoints`.
     */
    effectType: EffectRollbackDeductedLoyaltyPointsEffectTypeEnum;
    /**
    ...
    rewardId?: number;
    /**
     * The properties of the `rollbackDeductedLoyaltyPoints` effect.
     */
    props: RollbackDeductedLoyaltyPointsEffectProps;
}
 ...
 * @export
 */
export const EffectRollbackDeductedLoyaltyPointsEffectTypeEnum = {
    RollbackDeductedLoyaltyPoints: 'rollbackDeductedLoyaltyPoints',
} as const;
export type EffectRollbackDeductedLoyaltyPointsEffectTypeEnum = typeof EffectRollbackDeductedLoyaltyPointsEffectTypeEnum[keyof typeof EffectRollbackDeductedLoyaltyPointsEffectTypeEnum];


/**
 * Check if a given object implements the EffectRollbackDeductedLoyaltyPoints interface.
 */
export function instanceOfEffectRollbackDeductedLoyaltyPoints(value: object): value is EffectRollbackDeductedLoyaltyPoints {
    ...
    if (_v['effectType'] !== 'rollbackDeductedLoyaltyPoints') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectRollbackDeductedLoyaltyPointsFromJSON(json: any): EffectRollbackDeductedLoyaltyPoints {
    return EffectRollbackDeductedLoyaltyPointsFromJSONTyped(json, false);
}

export function EffectRollbackDeductedLoyaltyPointsFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectRollbackDeductedLoyaltyPoints {
    if (json == null) {
        return json;
    }
    return {
        ...
        'props': RollbackDeductedLoyaltyPointsEffectPropsFromJSON(json['props']),
    };
}

export function EffectRollbackDeductedLoyaltyPointsToJSON(json: any): EffectRollbackDeductedLoyaltyPoints {
    return EffectRollbackDeductedLoyaltyPointsToJSONTyped(json, false);
}

export function EffectRollbackDeductedLoyaltyPointsToJSONTyped(value?: EffectRollbackDeductedLoyaltyPoints | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'props': RollbackDeductedLoyaltyPointsEffectPropsToJSON(value['props']),
    };
}
