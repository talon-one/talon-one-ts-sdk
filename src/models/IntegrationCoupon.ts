 ...
 * 
 * @export
 * @interface IntegrationCoupon
 */
export interface IntegrationCoupon {
    /**
     * The internal ID of the coupon.
     * @type {number}
     * @memberof IntegrationCoupon
     */
    id: number;
    /**
...
/**
 * Check if a given object implements the IntegrationCoupon interface.
 */
export function instanceOfIntegrationCoupon(value: object): value is IntegrationCoupon {
...
export function IntegrationCouponFromJSON(json: any): IntegrationCoupon {
    return IntegrationCouponFromJSONTyped(json, false);
}

export function IntegrationCouponFromJSONTyped(json: any, ignoreDiscriminator: boolean): IntegrationCoupon {
    if (json == null) {
        return json;
    }
    return {
...
export function IntegrationCouponToJSON(json: any): IntegrationCoupon {
    return IntegrationCouponToJSONTyped(json, false);
}

export function IntegrationCouponToJSONTyped(value?: IntegrationCoupon | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
