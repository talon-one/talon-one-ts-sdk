...
import {
    ...
    CustomEffectPropsToJSONTyped,
} from './CustomEffectProps';

/**
 * 
 * @export
 * @interface EffectCustomEffect
 */
export interface EffectCustomEffect {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `customEffect`.
     */
    effectType: EffectCustomEffectEffectTypeEnum;
    /**
    ...
    rewardId?: number;
    /**
     * The properties of the `customEffect` effect.
     */
 ...
 * @export
 */
export const EffectCustomEffectEffectTypeEnum = {
    CustomEffect: 'customEffect',
} as const;
export type EffectCustomEffectEffectTypeEnum = typeof EffectCustomEffectEffectTypeEnum[keyof typeof EffectCustomEffectEffectTypeEnum];


/**
 * Check if a given object implements the EffectCustomEffect interface.
 */
export function instanceOfEffectCustomEffect(value: object): value is EffectCustomEffect {
    ...
    if (_v['effectType'] !== 'customEffect') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectCustomEffectFromJSON(json: any): EffectCustomEffect {
    return EffectCustomEffectFromJSONTyped(json, false);
}

export function EffectCustomEffectFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectCustomEffect {
    if (json == null) {
        return json;
    }
    return {
        ...
        'props': CustomEffectPropsFromJSON(json['props']),
    };
}

export function EffectCustomEffectToJSON(json: any): EffectCustomEffect {
    return EffectCustomEffectToJSONTyped(json, false);
}

export function EffectCustomEffectToJSONTyped(value?: EffectCustomEffect | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'props': CustomEffectPropsToJSON(value['props']),
    };
}
