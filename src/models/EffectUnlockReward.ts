...
import type { UnlockRewardEffectProps } from './UnlockRewardEffectProps';
import {
    UnlockRewardEffectPropsFromJSON,
    UnlockRewardEffectPropsFromJSONTyped,
    UnlockRewardEffectPropsToJSON,
    UnlockRewardEffectPropsToJSONTyped,
} from './UnlockRewardEffectProps';

/**
 * 
 * @export
 * @interface EffectUnlockReward
 */
export interface EffectUnlockReward {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `unlockReward`.
     */
    effectType: EffectUnlockRewardEffectTypeEnum;
    /**
    ...
    rewardId?: number;
    /**
     * The properties of the `unlockReward` effect.
     */
    props: UnlockRewardEffectProps;
}
 ...
 * @export
 */
export const EffectUnlockRewardEffectTypeEnum = {
    UnlockReward: 'unlockReward',
} as const;
export type EffectUnlockRewardEffectTypeEnum = typeof EffectUnlockRewardEffectTypeEnum[keyof typeof EffectUnlockRewardEffectTypeEnum];


/**
 * Check if a given object implements the EffectUnlockReward interface.
 */
export function instanceOfEffectUnlockReward(value: object): value is EffectUnlockReward {
    ...
    if (_v['effectType'] !== 'unlockReward') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectUnlockRewardFromJSON(json: any): EffectUnlockReward {
    return EffectUnlockRewardFromJSONTyped(json, false);
}

export function EffectUnlockRewardFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectUnlockReward {
    if (json == null) {
        return json;
    }
    return {
        ...
        'props': UnlockRewardEffectPropsFromJSON(json['props']),
    };
}

export function EffectUnlockRewardToJSON(json: any): EffectUnlockReward {
    return EffectUnlockRewardToJSONTyped(json, false);
}

export function EffectUnlockRewardToJSONTyped(value?: EffectUnlockReward | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'props': UnlockRewardEffectPropsToJSON(value['props']),
    };
}
