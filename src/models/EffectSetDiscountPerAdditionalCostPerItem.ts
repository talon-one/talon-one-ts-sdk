...
import {
    ...
    SetDiscountPerAdditionalCostPerItemEffectPropsToJSONTyped,
} from './SetDiscountPerAdditionalCostPerItemEffectProps';

/**
 * 
 * @export
 * @interface EffectSetDiscountPerAdditionalCostPerItem
 */
export interface EffectSetDiscountPerAdditionalCostPerItem {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `setDiscountPerAdditionalCostPerItem`.
     */
    effectType: EffectSetDiscountPerAdditionalCostPerItemEffectTypeEnum;
    /**
 ...
 * @export
 */
export const EffectSetDiscountPerAdditionalCostPerItemEffectTypeEnum = {
    SetDiscountPerAdditionalCostPerItem: 'setDiscountPerAdditionalCostPerItem',
} as const;
export type EffectSetDiscountPerAdditionalCostPerItemEffectTypeEnum = typeof EffectSetDiscountPerAdditionalCostPerItemEffectTypeEnum[keyof typeof EffectSetDiscountPerAdditionalCostPerItemEffectTypeEnum];


/**
 * Check if a given object implements the EffectSetDiscountPerAdditionalCostPerItem interface.
 */
export function instanceOfEffectSetDiscountPerAdditionalCostPerItem(value: object): value is EffectSetDiscountPerAdditionalCostPerItem {
    ...
    if (_v['effectType'] !== 'setDiscountPerAdditionalCostPerItem') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectSetDiscountPerAdditionalCostPerItemFromJSON(json: any): EffectSetDiscountPerAdditionalCostPerItem {
    return EffectSetDiscountPerAdditionalCostPerItemFromJSONTyped(json, false);
}

export function EffectSetDiscountPerAdditionalCostPerItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectSetDiscountPerAdditionalCostPerItem {
    if (json == null) {
        return json;
    }
    return {
...
export function EffectSetDiscountPerAdditionalCostPerItemToJSON(json: any): EffectSetDiscountPerAdditionalCostPerItem {
    return EffectSetDiscountPerAdditionalCostPerItemToJSONTyped(json, false);
}

export function EffectSetDiscountPerAdditionalCostPerItemToJSONTyped(value?: EffectSetDiscountPerAdditionalCostPerItem | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
