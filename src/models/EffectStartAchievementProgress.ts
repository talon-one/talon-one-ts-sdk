...
import {
    ...
    StartAchievementProgressEffectPropsToJSONTyped,
} from './StartAchievementProgressEffectProps';

/**
 * 
 * @export
 * @interface EffectStartAchievementProgress
 */
export interface EffectStartAchievementProgress {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `startAchievementProgress`.
     */
    effectType: EffectStartAchievementProgressEffectTypeEnum;
    /**
    ...
    rewardId?: number;
    /**
     * The properties of the `startAchievementProgress` effect.
     */
    props: StartAchievementProgressEffectProps;
}
 ...
 * @export
 */
export const EffectStartAchievementProgressEffectTypeEnum = {
    StartAchievementProgress: 'startAchievementProgress',
} as const;
export type EffectStartAchievementProgressEffectTypeEnum = typeof EffectStartAchievementProgressEffectTypeEnum[keyof typeof EffectStartAchievementProgressEffectTypeEnum];


/**
 * Check if a given object implements the EffectStartAchievementProgress interface.
 */
export function instanceOfEffectStartAchievementProgress(value: object): value is EffectStartAchievementProgress {
    ...
    if (_v['effectType'] !== 'startAchievementProgress') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectStartAchievementProgressFromJSON(json: any): EffectStartAchievementProgress {
    return EffectStartAchievementProgressFromJSONTyped(json, false);
}

export function EffectStartAchievementProgressFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectStartAchievementProgress {
    if (json == null) {
        return json;
    }
    return {
        ...
        'props': StartAchievementProgressEffectPropsFromJSON(json['props']),
    };
}

export function EffectStartAchievementProgressToJSON(json: any): EffectStartAchievementProgress {
    return EffectStartAchievementProgressToJSONTyped(json, false);
}

export function EffectStartAchievementProgressToJSONTyped(value?: EffectStartAchievementProgress | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'props': StartAchievementProgressEffectPropsToJSON(value['props']),
    };
}
