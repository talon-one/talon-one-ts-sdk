 ...
 * @export
 * @interface NewCustomerSessionV2
 */
export interface NewCustomerSessionV2 {
    /**
 ...
 * @export
 */
export const NewCustomerSessionV2StateEnum = {
    Open: 'open',
    Closed: 'closed',
...
/**
 * Check if a given object implements the NewCustomerSessionV2 interface.
 */
export function instanceOfNewCustomerSessionV2(value: object): value is NewCustomerSessionV2 {
    return true;
}

export function NewCustomerSessionV2FromJSON(json: any): NewCustomerSessionV2 {
    return NewCustomerSessionV2FromJSONTyped(json, false);
}

export function NewCustomerSessionV2FromJSONTyped(json: any, ignoreDiscriminator: boolean): NewCustomerSessionV2 {
    if (json == null) {
        return json;
    }
    return {
...
export function NewCustomerSessionV2ToJSON(json: any): NewCustomerSessionV2 {
    return NewCustomerSessionV2ToJSONTyped(json, false);
}

export function NewCustomerSessionV2ToJSONTyped(value?: NewCustomerSessionV2 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
