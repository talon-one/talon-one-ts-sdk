...
import {
    ...
    RollbackIncreasedAchievementProgressEffectPropsToJSONTyped,
} from './RollbackIncreasedAchievementProgressEffectProps';

/**
 * 
 * @export
 * @interface EffectRollbackIncreasedAchievementProgress
 */
export interface EffectRollbackIncreasedAchievementProgress {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `rollbackIncreasedAchievementProgress`.
     */
    effectType: EffectRollbackIncreasedAchievementProgressEffectTypeEnum;
    /**
    ...
    rewardId?: number;
    /**
     * The properties of the `rollbackIncreasedAchievementProgress` effect.
     */
    props: RollbackIncreasedAchievementProgressEffectProps;
}
 ...
 * @export
 */
export const EffectRollbackIncreasedAchievementProgressEffectTypeEnum = {
    RollbackIncreasedAchievementProgress: 'rollbackIncreasedAchievementProgress',
} as const;
export type EffectRollbackIncreasedAchievementProgressEffectTypeEnum = typeof EffectRollbackIncreasedAchievementProgressEffectTypeEnum[keyof typeof EffectRollbackIncreasedAchievementProgressEffectTypeEnum];


/**
 * Check if a given object implements the EffectRollbackIncreasedAchievementProgress interface.
 */
export function instanceOfEffectRollbackIncreasedAchievementProgress(value: object): value is EffectRollbackIncreasedAchievementProgress {
    ...
    if (_v['effectType'] !== 'rollbackIncreasedAchievementProgress') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectRollbackIncreasedAchievementProgressFromJSON(json: any): EffectRollbackIncreasedAchievementProgress {
    return EffectRollbackIncreasedAchievementProgressFromJSONTyped(json, false);
}

export function EffectRollbackIncreasedAchievementProgressFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectRollbackIncreasedAchievementProgress {
    if (json == null) {
        return json;
    }
    return {
        ...
        'props': RollbackIncreasedAchievementProgressEffectPropsFromJSON(json['props']),
    };
}

export function EffectRollbackIncreasedAchievementProgressToJSON(json: any): EffectRollbackIncreasedAchievementProgress {
    return EffectRollbackIncreasedAchievementProgressToJSONTyped(json, false);
}

export function EffectRollbackIncreasedAchievementProgressToJSONTyped(value?: EffectRollbackIncreasedAchievementProgress | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'props': RollbackIncreasedAchievementProgressEffectPropsToJSON(value['props']),
    };
}
