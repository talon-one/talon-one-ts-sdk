...
import {
    ...
    AddLoyaltyPointsEffectPropsToJSONTyped,
} from './AddLoyaltyPointsEffectProps';

/**
 * 
 * @export
 * @interface EffectAddLoyaltyPoints
 */
export interface EffectAddLoyaltyPoints {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `addLoyaltyPoints`.
     */
    effectType: EffectAddLoyaltyPointsEffectTypeEnum;
    /**
    ...
    rewardId?: number;
    /**
     * The properties of the `addLoyaltyPoints` effect.
     */
    props: AddLoyaltyPointsEffectProps;
}
 ...
 * @export
 */
export const EffectAddLoyaltyPointsEffectTypeEnum = {
    AddLoyaltyPoints: 'addLoyaltyPoints',
} as const;
export type EffectAddLoyaltyPointsEffectTypeEnum = typeof EffectAddLoyaltyPointsEffectTypeEnum[keyof typeof EffectAddLoyaltyPointsEffectTypeEnum];


/**
 * Check if a given object implements the EffectAddLoyaltyPoints interface.
 */
export function instanceOfEffectAddLoyaltyPoints(value: object): value is EffectAddLoyaltyPoints {
    ...
    if (_v['effectType'] !== 'addLoyaltyPoints') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectAddLoyaltyPointsFromJSON(json: any): EffectAddLoyaltyPoints {
    return EffectAddLoyaltyPointsFromJSONTyped(json, false);
}

export function EffectAddLoyaltyPointsFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectAddLoyaltyPoints {
    if (json == null) {
        return json;
    }
    return {
        ...
        'props': AddLoyaltyPointsEffectPropsFromJSON(json['props']),
    };
}

export function EffectAddLoyaltyPointsToJSON(json: any): EffectAddLoyaltyPoints {
    return EffectAddLoyaltyPointsToJSONTyped(json, false);
}

export function EffectAddLoyaltyPointsToJSONTyped(value?: EffectAddLoyaltyPoints | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'props': AddLoyaltyPointsEffectPropsToJSON(value['props']),
    };
}
