...
import {
    ...
    AwardGiveawayEffectPropsToJSONTyped,
} from './AwardGiveawayEffectProps';

/**
 * 
 * @export
 * @interface EffectAwardGiveaway
 */
export interface EffectAwardGiveaway {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `awardGiveaway`.
     */
    effectType: EffectAwardGiveawayEffectTypeEnum;
    /**
 ...
 * @export
 */
export const EffectAwardGiveawayEffectTypeEnum = {
    AwardGiveaway: 'awardGiveaway',
} as const;
export type EffectAwardGiveawayEffectTypeEnum = typeof EffectAwardGiveawayEffectTypeEnum[keyof typeof EffectAwardGiveawayEffectTypeEnum];


/**
 * Check if a given object implements the EffectAwardGiveaway interface.
 */
export function instanceOfEffectAwardGiveaway(value: object): value is EffectAwardGiveaway {
    ...
    if (_v['effectType'] !== 'awardGiveaway') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectAwardGiveawayFromJSON(json: any): EffectAwardGiveaway {
    return EffectAwardGiveawayFromJSONTyped(json, false);
}

export function EffectAwardGiveawayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectAwardGiveaway {
    if (json == null) {
        return json;
    }
    return {
...
export function EffectAwardGiveawayToJSON(json: any): EffectAwardGiveaway {
    return EffectAwardGiveawayToJSONTyped(json, false);
}

export function EffectAwardGiveawayToJSONTyped(value?: EffectAwardGiveaway | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
