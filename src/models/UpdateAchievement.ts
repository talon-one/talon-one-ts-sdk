...
export function UpdateAchievementFromJSON(json: any): UpdateAchievement {
    return UpdateAchievementFromJSONTyped(json, false);
}

export function UpdateAchievementFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateAchievement {
    if (json == null) {
        return json;
    }
    return {
...
export function UpdateAchievementToJSON(json: any): UpdateAchievement {
    return UpdateAchievementToJSONTyped(json, false);
}

export function UpdateAchievementToJSONTyped(value?: UpdateAchievement | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
