...
import {
    ...
    AddToAudienceEffectPropsToJSONTyped,
} from './AddToAudienceEffectProps';

/**
 * 
 * @export
 * @interface EffectAddToAudience
 */
export interface EffectAddToAudience {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `addToAudience`.
     */
    effectType: EffectAddToAudienceEffectTypeEnum;
    /**
 ...
 * @export
 */
export const EffectAddToAudienceEffectTypeEnum = {
    AddToAudience: 'addToAudience',
} as const;
export type EffectAddToAudienceEffectTypeEnum = typeof EffectAddToAudienceEffectTypeEnum[keyof typeof EffectAddToAudienceEffectTypeEnum];


/**
 * Check if a given object implements the EffectAddToAudience interface.
 */
export function instanceOfEffectAddToAudience(value: object): value is EffectAddToAudience {
    ...
    if (_v['effectType'] !== 'addToAudience') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectAddToAudienceFromJSON(json: any): EffectAddToAudience {
    return EffectAddToAudienceFromJSONTyped(json, false);
}

export function EffectAddToAudienceFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectAddToAudience {
    if (json == null) {
        return json;
    }
    return {
...
export function EffectAddToAudienceToJSON(json: any): EffectAddToAudience {
    return EffectAddToAudienceToJSONTyped(json, false);
}

export function EffectAddToAudienceToJSONTyped(value?: EffectAddToAudience | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
