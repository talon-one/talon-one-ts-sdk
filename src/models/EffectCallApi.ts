...
import {
    ...
    TriggerWebhookEffectPropsToJSONTyped,
} from './TriggerWebhookEffectProps';

/**
 * 
 * @export
 * @interface EffectCallApi
 */
export interface EffectCallApi {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `callApi`.
     */
    effectType: EffectCallApiEffectTypeEnum;
    /**
     ...
     */
    props: TriggerWebhookEffectProps;
}
 ...
 * @export
 */
export const EffectCallApiEffectTypeEnum = {
    CallApi: 'callApi',
} as const;
export type EffectCallApiEffectTypeEnum = typeof EffectCallApiEffectTypeEnum[keyof typeof EffectCallApiEffectTypeEnum];


/**
 * Check if a given object implements the EffectCallApi interface.
 */
export function instanceOfEffectCallApi(value: object): value is EffectCallApi {
    ...
    if (_v['effectType'] !== 'callApi') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectCallApiFromJSON(json: any): EffectCallApi {
    return EffectCallApiFromJSONTyped(json, false);
}

export function EffectCallApiFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectCallApi {
    if (json == null) {
        return json;
    }
    return {
        ...
        'props': TriggerWebhookEffectPropsFromJSON(json['props']),
    };
}

export function EffectCallApiToJSON(json: any): EffectCallApi {
    return EffectCallApiToJSONTyped(json, false);
}

export function EffectCallApiToJSONTyped(value?: EffectCallApi | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'props': TriggerWebhookEffectPropsToJSON(value['props']),
    };
}
