...
import {
    ...
    UpdateAttributeEffectPropsToJSONTyped,
...
export interface EffectSet {
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `set`.
     */
    effectType: EffectSetEffectTypeEnum;
    /**
 ...
 * @export
 */
export const EffectSetEffectTypeEnum = {
    Set: 'set',
} as const;
export type EffectSetEffectTypeEnum = typeof EffectSetEffectTypeEnum[keyof typeof EffectSetEffectTypeEnum];


/**
 * Check if a given object implements the EffectSet interface.
 */
export function instanceOfEffectSet(value: object): value is EffectSet {
    ...
    if (_v['effectType'] !== 'set') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectSetFromJSON(json: any): EffectSet {
    return EffectSetFromJSONTyped(json, false);
}

export function EffectSetFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectSet {
    if (json == null) {
        return json;
    }
    return {
...
export function EffectSetToJSON(json: any): EffectSet {
    return EffectSetToJSONTyped(json, false);
}

export function EffectSetToJSONTyped(value?: EffectSet | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
