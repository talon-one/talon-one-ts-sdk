...
import {
    ...
    ExtendLoyaltyPointsExpiryDateEffectPropsToJSONTyped,
} from './ExtendLoyaltyPointsExpiryDateEffectProps';

/**
 * 
 * @export
 * @interface EffectExtendLoyaltyPointsExpiryDate
 */
export interface EffectExtendLoyaltyPointsExpiryDate {
    /**
     ...
     */
    effectType: EffectExtendLoyaltyPointsExpiryDateEffectTypeEnum;
    /**
    ...
    rewardId?: number;
    /**
     * The properties of the `extendLoyaltyPointsExpiryDate` effect.
     */
    props: ExtendLoyaltyPointsExpiryDateEffectProps;
}
 ...
 * @export
 */
export const EffectExtendLoyaltyPointsExpiryDateEffectTypeEnum = {
    ExtendLoyaltyPointsExpiryDate: 'extendLoyaltyPointsExpiryDate',
} as const;
export type EffectExtendLoyaltyPointsExpiryDateEffectTypeEnum = typeof EffectExtendLoyaltyPointsExpiryDateEffectTypeEnum[keyof typeof EffectExtendLoyaltyPointsExpiryDateEffectTypeEnum];


/**
 * Check if a given object implements the EffectExtendLoyaltyPointsExpiryDate interface.
 */
export function instanceOfEffectExtendLoyaltyPointsExpiryDate(value: object): value is EffectExtendLoyaltyPointsExpiryDate {
    ...
    if (_v['effectType'] !== 'extendLoyaltyPointsExpiryDate') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectExtendLoyaltyPointsExpiryDateFromJSON(json: any): EffectExtendLoyaltyPointsExpiryDate {
    return EffectExtendLoyaltyPointsExpiryDateFromJSONTyped(json, false);
}

export function EffectExtendLoyaltyPointsExpiryDateFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectExtendLoyaltyPointsExpiryDate {
    if (json == null) {
        return json;
    }
    return {
        ...
        'props': ExtendLoyaltyPointsExpiryDateEffectPropsFromJSON(json['props']),
    };
}

export function EffectExtendLoyaltyPointsExpiryDateToJSON(json: any): EffectExtendLoyaltyPointsExpiryDate {
    return EffectExtendLoyaltyPointsExpiryDateToJSONTyped(json, false);
}

export function EffectExtendLoyaltyPointsExpiryDateToJSONTyped(value?: EffectExtendLoyaltyPointsExpiryDate | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'props': ExtendLoyaltyPointsExpiryDateEffectPropsToJSON(value['props']),
    };
}
