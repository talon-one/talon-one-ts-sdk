...
import {
    ...
    RejectCouponEffectPropsToJSONTyped,
} from './RejectCouponEffectProps';

/**
 * 
 * @export
 * @interface EffectRejectCoupon
 */
export interface EffectRejectCoupon {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `rejectCoupon`.
     */
    effectType: EffectRejectCouponEffectTypeEnum;
    /**
 ...
 * @export
 */
export const EffectRejectCouponEffectTypeEnum = {
    RejectCoupon: 'rejectCoupon',
} as const;
export type EffectRejectCouponEffectTypeEnum = typeof EffectRejectCouponEffectTypeEnum[keyof typeof EffectRejectCouponEffectTypeEnum];


/**
 * Check if a given object implements the EffectRejectCoupon interface.
 */
export function instanceOfEffectRejectCoupon(value: object): value is EffectRejectCoupon {
    ...
    if (_v['effectType'] !== 'rejectCoupon') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectRejectCouponFromJSON(json: any): EffectRejectCoupon {
    return EffectRejectCouponFromJSONTyped(json, false);
}

export function EffectRejectCouponFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectRejectCoupon {
    if (json == null) {
        return json;
    }
    return {
...
export function EffectRejectCouponToJSON(json: any): EffectRejectCoupon {
    return EffectRejectCouponToJSONTyped(json, false);
}

export function EffectRejectCouponToJSONTyped(value?: EffectRejectCoupon | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
