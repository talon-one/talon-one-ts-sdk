...
import {
    ...
    AcceptReferralEffectPropsToJSONTyped,
} from './AcceptReferralEffectProps';

/**
 * 
 * @export
 * @interface EffectAcceptReferral
 */
export interface EffectAcceptReferral {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `acceptReferral`.
     */
    effectType: EffectAcceptReferralEffectTypeEnum;
    /**
    ...
    rewardId?: number;
    /**
     * The properties of the `acceptReferral` effect.
     */
    props: AcceptReferralEffectProps;
}
 ...
 * @export
 */
export const EffectAcceptReferralEffectTypeEnum = {
    AcceptReferral: 'acceptReferral',
} as const;
export type EffectAcceptReferralEffectTypeEnum = typeof EffectAcceptReferralEffectTypeEnum[keyof typeof EffectAcceptReferralEffectTypeEnum];


/**
 * Check if a given object implements the EffectAcceptReferral interface.
 */
export function instanceOfEffectAcceptReferral(value: object): value is EffectAcceptReferral {
    ...
    if (_v['effectType'] !== 'acceptReferral') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectAcceptReferralFromJSON(json: any): EffectAcceptReferral {
    return EffectAcceptReferralFromJSONTyped(json, false);
}

export function EffectAcceptReferralFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectAcceptReferral {
    if (json == null) {
        return json;
    }
    return {
        ...
        'props': AcceptReferralEffectPropsFromJSON(json['props']),
    };
}

export function EffectAcceptReferralToJSON(json: any): EffectAcceptReferral {
    return EffectAcceptReferralToJSONTyped(json, false);
}

export function EffectAcceptReferralToJSONTyped(value?: EffectAcceptReferral | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'props': AcceptReferralEffectPropsToJSON(value['props']),
    };
}
