 ...
 * 
 * @export
 * @interface EffectAddNegativeLoyaltyPoints
 */
export interface EffectAddNegativeLoyaltyPoints {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `addNegativeLoyaltyPoints`.
     */
    effectType: EffectAddNegativeLoyaltyPointsEffectTypeEnum;
    /**
 ...
 * @export
 */
export const EffectAddNegativeLoyaltyPointsEffectTypeEnum = {
    AddNegativeLoyaltyPoints: 'addNegativeLoyaltyPoints',
} as const;
export type EffectAddNegativeLoyaltyPointsEffectTypeEnum = typeof EffectAddNegativeLoyaltyPointsEffectTypeEnum[keyof typeof EffectAddNegativeLoyaltyPointsEffectTypeEnum];


/**
 * Check if a given object implements the EffectAddNegativeLoyaltyPoints interface.
 */
export function instanceOfEffectAddNegativeLoyaltyPoints(value: object): value is EffectAddNegativeLoyaltyPoints {
    ...
    if (_v['effectType'] !== 'addNegativeLoyaltyPoints') return false;
    
    return true;
}

export function EffectAddNegativeLoyaltyPointsFromJSON(json: any): EffectAddNegativeLoyaltyPoints {
    return EffectAddNegativeLoyaltyPointsFromJSONTyped(json, false);
}

export function EffectAddNegativeLoyaltyPointsFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectAddNegativeLoyaltyPoints {
    if (json == null) {
        return json;
    }
    return {
...
export function EffectAddNegativeLoyaltyPointsToJSON(json: any): EffectAddNegativeLoyaltyPoints {
    return EffectAddNegativeLoyaltyPointsToJSONTyped(json, false);
}

export function EffectAddNegativeLoyaltyPointsToJSONTyped(value?: EffectAddNegativeLoyaltyPoints | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
