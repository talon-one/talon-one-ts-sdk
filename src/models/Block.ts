...
import { type GroupBlock, GroupBlockFromJSONTyped, GroupBlockToJSON } from './GroupBlock';
 ...
 */
export function instanceOfBlock(value: any): value is Block {
...
export function BlockFromJSONTyped(json: any, ignoreDiscriminator: boolean): Block {
    ...
    switch (json['type']) {
        ...
        case 'group':
            return Object.assign({}, GroupBlockFromJSONTyped(json, true), { type: 'group' } as const);
        case 'passthrough':
...
export function BlockToJSONTyped(value?: Block | null, ignoreDiscriminator: boolean = false): any {
    ...
    switch (value['type']) {
        ...
        case 'group':
            return Object.assign({}, GroupBlockToJSON(value), { 'type': 'group' } as const);
        case 'passthrough':
