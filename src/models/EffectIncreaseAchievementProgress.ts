...
import {
    ...
    IncreaseAchievementProgressEffectPropsToJSONTyped,
} from './IncreaseAchievementProgressEffectProps';

/**
 * 
 * @export
 * @interface EffectIncreaseAchievementProgress
 */
export interface EffectIncreaseAchievementProgress {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `increaseAchievementProgress`.
     */
    effectType: EffectIncreaseAchievementProgressEffectTypeEnum;
    /**
    ...
    rewardId?: number;
    /**
     * The properties of the `increaseAchievementProgress` effect.
     */
    props: IncreaseAchievementProgressEffectProps;
}
 ...
 * @export
 */
export const EffectIncreaseAchievementProgressEffectTypeEnum = {
    IncreaseAchievementProgress: 'increaseAchievementProgress',
} as const;
export type EffectIncreaseAchievementProgressEffectTypeEnum = typeof EffectIncreaseAchievementProgressEffectTypeEnum[keyof typeof EffectIncreaseAchievementProgressEffectTypeEnum];


/**
 * Check if a given object implements the EffectIncreaseAchievementProgress interface.
 */
export function instanceOfEffectIncreaseAchievementProgress(value: object): value is EffectIncreaseAchievementProgress {
    ...
    if (_v['effectType'] !== 'increaseAchievementProgress') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectIncreaseAchievementProgressFromJSON(json: any): EffectIncreaseAchievementProgress {
    return EffectIncreaseAchievementProgressFromJSONTyped(json, false);
}

export function EffectIncreaseAchievementProgressFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectIncreaseAchievementProgress {
    if (json == null) {
        return json;
    }
    return {
        ...
        'props': IncreaseAchievementProgressEffectPropsFromJSON(json['props']),
    };
}

export function EffectIncreaseAchievementProgressToJSON(json: any): EffectIncreaseAchievementProgress {
    return EffectIncreaseAchievementProgressToJSONTyped(json, false);
}

export function EffectIncreaseAchievementProgressToJSONTyped(value?: EffectIncreaseAchievementProgress | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'props': IncreaseAchievementProgressEffectPropsToJSON(value['props']),
    };
}
