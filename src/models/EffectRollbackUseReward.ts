...
import type { RollbackUseRewardEffectProps } from './RollbackUseRewardEffectProps';
import {
    RollbackUseRewardEffectPropsFromJSON,
    RollbackUseRewardEffectPropsFromJSONTyped,
    RollbackUseRewardEffectPropsToJSON,
    RollbackUseRewardEffectPropsToJSONTyped,
} from './RollbackUseRewardEffectProps';

/**
 * 
 * @export
 * @interface EffectRollbackUseReward
 */
export interface EffectRollbackUseReward {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `rollbackUseReward`.
     */
    effectType: EffectRollbackUseRewardEffectTypeEnum;
    /**
    ...
    rewardId?: number;
    /**
     * The properties of the `rollbackUseReward` effect.
     */
    props: RollbackUseRewardEffectProps;
}
 ...
 * @export
 */
export const EffectRollbackUseRewardEffectTypeEnum = {
    RollbackUseReward: 'rollbackUseReward',
} as const;
export type EffectRollbackUseRewardEffectTypeEnum = typeof EffectRollbackUseRewardEffectTypeEnum[keyof typeof EffectRollbackUseRewardEffectTypeEnum];


/**
 * Check if a given object implements the EffectRollbackUseReward interface.
 */
export function instanceOfEffectRollbackUseReward(value: object): value is EffectRollbackUseReward {
    ...
    if (_v['effectType'] !== 'rollbackUseReward') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectRollbackUseRewardFromJSON(json: any): EffectRollbackUseReward {
    return EffectRollbackUseRewardFromJSONTyped(json, false);
}

export function EffectRollbackUseRewardFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectRollbackUseReward {
    if (json == null) {
        return json;
    }
    return {
        ...
        'props': RollbackUseRewardEffectPropsFromJSON(json['props']),
    };
}

export function EffectRollbackUseRewardToJSON(json: any): EffectRollbackUseReward {
    return EffectRollbackUseRewardToJSONTyped(json, false);
}

export function EffectRollbackUseRewardToJSONTyped(value?: EffectRollbackUseReward | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'props': RollbackUseRewardEffectPropsToJSON(value['props']),
    };
}
