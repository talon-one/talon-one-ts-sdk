...
export interface EffectError {
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `error`.
     */
    effectType: EffectErrorEffectTypeEnum;
    /**
    ...
    rewardId?: number;
    /**
     * The properties of the `error` effect.
     */
    props: ErrorEffectProps;
}
 ...
 * @export
 */
export const EffectErrorEffectTypeEnum = {
    Error: 'error',
} as const;
export type EffectErrorEffectTypeEnum = typeof EffectErrorEffectTypeEnum[keyof typeof EffectErrorEffectTypeEnum];


/**
 * Check if a given object implements the EffectError interface.
 */
export function instanceOfEffectError(value: object): value is EffectError {
    ...
    if (_v['effectType'] !== 'error') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectErrorFromJSON(json: any): EffectError {
    return EffectErrorFromJSONTyped(json, false);
}

export function EffectErrorFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectError {
    if (json == null) {
        return json;
    }
    return {
        ...
        'props': ErrorEffectPropsFromJSON(json['props']),
    };
}

export function EffectErrorToJSON(json: any): EffectError {
    return EffectErrorToJSONTyped(json, false);
}

export function EffectErrorToJSONTyped(value?: EffectError | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'props': ErrorEffectPropsToJSON(value['props']),
    };
}
