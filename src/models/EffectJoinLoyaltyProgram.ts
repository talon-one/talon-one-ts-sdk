...
import type { JoinLoyaltyProgramEffectProps } from './JoinLoyaltyProgramEffectProps';
import {
    JoinLoyaltyProgramEffectPropsFromJSON,
    JoinLoyaltyProgramEffectPropsFromJSONTyped,
    JoinLoyaltyProgramEffectPropsToJSON,
    JoinLoyaltyProgramEffectPropsToJSONTyped,
} from './JoinLoyaltyProgramEffectProps';

/**
 * 
 * @export
 * @interface EffectJoinLoyaltyProgram
 */
export interface EffectJoinLoyaltyProgram {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `joinLoyaltyProgram`.
     */
    effectType: EffectJoinLoyaltyProgramEffectTypeEnum;
    /**
 ...
 * @export
 */
export const EffectJoinLoyaltyProgramEffectTypeEnum = {
    JoinLoyaltyProgram: 'joinLoyaltyProgram',
} as const;
export type EffectJoinLoyaltyProgramEffectTypeEnum = typeof EffectJoinLoyaltyProgramEffectTypeEnum[keyof typeof EffectJoinLoyaltyProgramEffectTypeEnum];


/**
 * Check if a given object implements the EffectJoinLoyaltyProgram interface.
 */
export function instanceOfEffectJoinLoyaltyProgram(value: object): value is EffectJoinLoyaltyProgram {
    ...
    if (_v['effectType'] !== 'joinLoyaltyProgram') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectJoinLoyaltyProgramFromJSON(json: any): EffectJoinLoyaltyProgram {
    return EffectJoinLoyaltyProgramFromJSONTyped(json, false);
}

export function EffectJoinLoyaltyProgramFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectJoinLoyaltyProgram {
    if (json == null) {
        return json;
    }
    return {
...
export function EffectJoinLoyaltyProgramToJSON(json: any): EffectJoinLoyaltyProgram {
    return EffectJoinLoyaltyProgramToJSONTyped(json, false);
}

export function EffectJoinLoyaltyProgramToJSONTyped(value?: EffectJoinLoyaltyProgram | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
