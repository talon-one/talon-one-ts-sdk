...
export function InventoryCouponFromJSON(json: any): InventoryCoupon {
    return InventoryCouponFromJSONTyped(json, false);
}

export function InventoryCouponFromJSONTyped(json: any, ignoreDiscriminator: boolean): InventoryCoupon {
    if (json == null) {
        return json;
    }
    return {
...
export function InventoryCouponToJSON(json: any): InventoryCoupon {
    return InventoryCouponToJSONTyped(json, false);
}

export function InventoryCouponToJSONTyped(value?: InventoryCoupon | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
