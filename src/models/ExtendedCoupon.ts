...
export function ExtendedCouponFromJSON(json: any): ExtendedCoupon {
    return ExtendedCouponFromJSONTyped(json, false);
}

export function ExtendedCouponFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExtendedCoupon {
    if (json == null) {
        return json;
    }
    return {
...
export function ExtendedCouponToJSON(json: any): ExtendedCoupon {
    return ExtendedCouponToJSONTyped(json, false);
}

export function ExtendedCouponToJSONTyped(value?: ExtendedCoupon | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
