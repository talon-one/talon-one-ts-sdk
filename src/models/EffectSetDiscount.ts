...
import {
    ...
    SetDiscountEffectPropsToJSONTyped,
} from './SetDiscountEffectProps';

/**
 * 
 * @export
 * @interface EffectSetDiscount
 */
export interface EffectSetDiscount {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `setDiscount`.
     */
    effectType: EffectSetDiscountEffectTypeEnum;
    /**
    ...
    rewardId?: number;
    /**
     * The properties of the `setDiscount` effect.
     */
    props: SetDiscountEffectProps;
}
 ...
 * @export
 */
export const EffectSetDiscountEffectTypeEnum = {
    SetDiscount: 'setDiscount',
} as const;
export type EffectSetDiscountEffectTypeEnum = typeof EffectSetDiscountEffectTypeEnum[keyof typeof EffectSetDiscountEffectTypeEnum];


/**
 * Check if a given object implements the EffectSetDiscount interface.
 */
export function instanceOfEffectSetDiscount(value: object): value is EffectSetDiscount {
    ...
    if (_v['effectType'] !== 'setDiscount') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectSetDiscountFromJSON(json: any): EffectSetDiscount {
    return EffectSetDiscountFromJSONTyped(json, false);
}

export function EffectSetDiscountFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectSetDiscount {
    if (json == null) {
        return json;
    }
    return {
        ...
        'props': SetDiscountEffectPropsFromJSON(json['props']),
    };
}

export function EffectSetDiscountToJSON(json: any): EffectSetDiscount {
    return EffectSetDiscountToJSONTyped(json, false);
}

export function EffectSetDiscountToJSONTyped(value?: EffectSetDiscount | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'props': SetDiscountEffectPropsToJSON(value['props']),
    };
}
