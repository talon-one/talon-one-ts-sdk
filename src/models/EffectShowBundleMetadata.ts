...
import {
    ...
    ShowBundleMetadataEffectPropsToJSONTyped,
} from './ShowBundleMetadataEffectProps';

/**
 * 
 * @export
 * @interface EffectShowBundleMetadata
 */
export interface EffectShowBundleMetadata {
    /**
     ...
     */
    effectType: EffectShowBundleMetadataEffectTypeEnum;
    /**
     ...
     * @deprecated
     */
    props: ShowBundleMetadataEffectProps;
}
 ...
 * @export
 */
export const EffectShowBundleMetadataEffectTypeEnum = {
    ShowBundleMetadata: 'showBundleMetadata',
} as const;
export type EffectShowBundleMetadataEffectTypeEnum = typeof EffectShowBundleMetadataEffectTypeEnum[keyof typeof EffectShowBundleMetadataEffectTypeEnum];


/**
 * Check if a given object implements the EffectShowBundleMetadata interface.
 */
export function instanceOfEffectShowBundleMetadata(value: object): value is EffectShowBundleMetadata {
    ...
    if (_v['effectType'] !== 'showBundleMetadata') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectShowBundleMetadataFromJSON(json: any): EffectShowBundleMetadata {
    return EffectShowBundleMetadataFromJSONTyped(json, false);
}

export function EffectShowBundleMetadataFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectShowBundleMetadata {
    if (json == null) {
        return json;
    }
    return {
...
export function EffectShowBundleMetadataToJSON(json: any): EffectShowBundleMetadata {
    return EffectShowBundleMetadataToJSONTyped(json, false);
}

export function EffectShowBundleMetadataToJSONTyped(value?: EffectShowBundleMetadata | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
