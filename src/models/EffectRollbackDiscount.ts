...
import {
    ...
    RollbackDiscountEffectPropsToJSONTyped,
} from './RollbackDiscountEffectProps';

/**
 * 
 * @export
 * @interface EffectRollbackDiscount
 */
export interface EffectRollbackDiscount {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `rollbackDiscount`.
     */
    effectType: EffectRollbackDiscountEffectTypeEnum;
    /**
    ...
    rewardId?: number;
    /**
     * The properties of the `rollbackDiscount` effect.
     */
    props: RollbackDiscountEffectProps;
}
 ...
 * @export
 */
export const EffectRollbackDiscountEffectTypeEnum = {
    RollbackDiscount: 'rollbackDiscount',
} as const;
export type EffectRollbackDiscountEffectTypeEnum = typeof EffectRollbackDiscountEffectTypeEnum[keyof typeof EffectRollbackDiscountEffectTypeEnum];


/**
 * Check if a given object implements the EffectRollbackDiscount interface.
 */
export function instanceOfEffectRollbackDiscount(value: object): value is EffectRollbackDiscount {
    ...
    if (_v['effectType'] !== 'rollbackDiscount') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectRollbackDiscountFromJSON(json: any): EffectRollbackDiscount {
    return EffectRollbackDiscountFromJSONTyped(json, false);
}

export function EffectRollbackDiscountFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectRollbackDiscount {
    if (json == null) {
        return json;
    }
    return {
        ...
        'props': RollbackDiscountEffectPropsFromJSON(json['props']),
    };
}

export function EffectRollbackDiscountToJSON(json: any): EffectRollbackDiscount {
    return EffectRollbackDiscountToJSONTyped(json, false);
}

export function EffectRollbackDiscountToJSONTyped(value?: EffectRollbackDiscount | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'props': RollbackDiscountEffectPropsToJSON(value['props']),
    };
}
