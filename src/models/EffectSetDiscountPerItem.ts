...
import {
    ...
    SetDiscountPerItemEffectPropsToJSONTyped,
} from './SetDiscountPerItemEffectProps';

/**
 * 
 * @export
 * @interface EffectSetDiscountPerItem
 */
export interface EffectSetDiscountPerItem {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `setDiscountPerItem`.
     */
    effectType: EffectSetDiscountPerItemEffectTypeEnum;
    /**
    ...
    rewardId?: number;
    /**
     * The properties of the `setDiscountPerItem` effect.
     */
    props: SetDiscountPerItemEffectProps;
}
 ...
 * @export
 */
export const EffectSetDiscountPerItemEffectTypeEnum = {
    SetDiscountPerItem: 'setDiscountPerItem',
} as const;
export type EffectSetDiscountPerItemEffectTypeEnum = typeof EffectSetDiscountPerItemEffectTypeEnum[keyof typeof EffectSetDiscountPerItemEffectTypeEnum];


/**
 * Check if a given object implements the EffectSetDiscountPerItem interface.
 */
export function instanceOfEffectSetDiscountPerItem(value: object): value is EffectSetDiscountPerItem {
    ...
    if (_v['effectType'] !== 'setDiscountPerItem') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectSetDiscountPerItemFromJSON(json: any): EffectSetDiscountPerItem {
    return EffectSetDiscountPerItemFromJSONTyped(json, false);
}

export function EffectSetDiscountPerItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectSetDiscountPerItem {
    if (json == null) {
        return json;
    }
    return {
        ...
        'props': SetDiscountPerItemEffectPropsFromJSON(json['props']),
    };
}

export function EffectSetDiscountPerItemToJSON(json: any): EffectSetDiscountPerItem {
    return EffectSetDiscountPerItemToJSONTyped(json, false);
}

export function EffectSetDiscountPerItemToJSONTyped(value?: EffectSetDiscountPerItem | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'props': SetDiscountPerItemEffectPropsToJSON(value['props']),
    };
}
