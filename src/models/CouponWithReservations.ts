...
import type { CouponReservation } from './CouponReservation';
import {
    CouponReservationFromJSON,
    CouponReservationFromJSONTyped,
    CouponReservationToJSON,
    CouponReservationToJSONTyped,
 ...
 * 
 * @export
 * @interface CouponWithReservations
 */
export interface CouponWithReservations {
    /**
    ...
    /**
     * The customer profile and timestamp of each reservation.
     */
    reservations?: Array<CouponReservation>;
}

/**
 * Check if a given object implements the CouponWithReservations interface.
 */
export function instanceOfCouponWithReservations(value: object): value is CouponWithReservations {
...
export function CouponWithReservationsFromJSON(json: any): CouponWithReservations {
    return CouponWithReservationsFromJSONTyped(json, false);
}

export function CouponWithReservationsFromJSONTyped(json: any, ignoreDiscriminator: boolean): CouponWithReservations {
    if (json == null) {
        return json;
    }
    return {
        ...
        'reservations': json['reservations'] == null ? undefined : ((json['reservations'] as Array<any>).map(CouponReservationFromJSON)),
    };
}

export function CouponWithReservationsToJSON(json: any): CouponWithReservations {
    return CouponWithReservationsToJSONTyped(json, false);
}

export function CouponWithReservationsToJSONTyped(value?: CouponWithReservations | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'reservations': value['reservations'] == null ? undefined : ((value['reservations'] as Array<any>).map(CouponReservationToJSON)),
    };
}
