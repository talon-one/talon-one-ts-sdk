...
import {
    ...
    ReserveCouponEffectPropsToJSONTyped,
} from './ReserveCouponEffectProps';

/**
 * 
 * @export
 * @interface EffectReserveCoupon
 */
export interface EffectReserveCoupon {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `reserveCoupon`.
     */
    effectType: EffectReserveCouponEffectTypeEnum;
    /**
    ...
    rewardId?: number;
    /**
     * The properties of the `reserveCoupon` effect.
     */
    props: ReserveCouponEffectProps;
}
 ...
 * @export
 */
export const EffectReserveCouponEffectTypeEnum = {
    ReserveCoupon: 'reserveCoupon',
} as const;
export type EffectReserveCouponEffectTypeEnum = typeof EffectReserveCouponEffectTypeEnum[keyof typeof EffectReserveCouponEffectTypeEnum];


/**
 * Check if a given object implements the EffectReserveCoupon interface.
 */
export function instanceOfEffectReserveCoupon(value: object): value is EffectReserveCoupon {
    ...
    if (_v['effectType'] !== 'reserveCoupon') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectReserveCouponFromJSON(json: any): EffectReserveCoupon {
    return EffectReserveCouponFromJSONTyped(json, false);
}

export function EffectReserveCouponFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectReserveCoupon {
    if (json == null) {
        return json;
    }
    return {
        ...
        'props': ReserveCouponEffectPropsFromJSON(json['props']),
    };
}

export function EffectReserveCouponToJSON(json: any): EffectReserveCoupon {
    return EffectReserveCouponToJSONTyped(json, false);
}

export function EffectReserveCouponToJSONTyped(value?: EffectReserveCoupon | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'props': ReserveCouponEffectPropsToJSON(value['props']),
    };
}
