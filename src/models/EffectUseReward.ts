...
import type { UseRewardEffectProps } from './UseRewardEffectProps';
import {
    UseRewardEffectPropsFromJSON,
    UseRewardEffectPropsFromJSONTyped,
    UseRewardEffectPropsToJSON,
    UseRewardEffectPropsToJSONTyped,
} from './UseRewardEffectProps';

/**
 * 
 * @export
 * @interface EffectUseReward
 */
export interface EffectUseReward {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `useReward`.
     */
    effectType: EffectUseRewardEffectTypeEnum;
    /**
    ...
    rewardId?: number;
    /**
     * The properties of the `useReward` effect.
     */
    props: UseRewardEffectProps;
}
 ...
 * @export
 */
export const EffectUseRewardEffectTypeEnum = {
    UseReward: 'useReward',
} as const;
export type EffectUseRewardEffectTypeEnum = typeof EffectUseRewardEffectTypeEnum[keyof typeof EffectUseRewardEffectTypeEnum];


/**
 * Check if a given object implements the EffectUseReward interface.
 */
export function instanceOfEffectUseReward(value: object): value is EffectUseReward {
    ...
    if (_v['effectType'] !== 'useReward') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectUseRewardFromJSON(json: any): EffectUseReward {
    return EffectUseRewardFromJSONTyped(json, false);
}

export function EffectUseRewardFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectUseReward {
    if (json == null) {
        return json;
    }
    return {
        ...
        'props': UseRewardEffectPropsFromJSON(json['props']),
    };
}

export function EffectUseRewardToJSON(json: any): EffectUseReward {
    return EffectUseRewardToJSONTyped(json, false);
}

export function EffectUseRewardToJSONTyped(value?: EffectUseReward | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'props': UseRewardEffectPropsToJSON(value['props']),
    };
}
