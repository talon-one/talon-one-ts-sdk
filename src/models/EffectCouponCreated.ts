...
import {
    ...
    CouponCreatedEffectPropsToJSONTyped,
} from './CouponCreatedEffectProps';

/**
 * 
 * @export
 * @interface EffectCouponCreated
 */
export interface EffectCouponCreated {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `couponCreated`.
     */
    effectType: EffectCouponCreatedEffectTypeEnum;
    /**
     ...
     */
    props: CouponCreatedEffectProps;
}
 ...
 * @export
 */
export const EffectCouponCreatedEffectTypeEnum = {
    CouponCreated: 'couponCreated',
} as const;
export type EffectCouponCreatedEffectTypeEnum = typeof EffectCouponCreatedEffectTypeEnum[keyof typeof EffectCouponCreatedEffectTypeEnum];


/**
 * Check if a given object implements the EffectCouponCreated interface.
 */
export function instanceOfEffectCouponCreated(value: object): value is EffectCouponCreated {
    ...
    if (_v['effectType'] !== 'couponCreated') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectCouponCreatedFromJSON(json: any): EffectCouponCreated {
    return EffectCouponCreatedFromJSONTyped(json, false);
}

export function EffectCouponCreatedFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectCouponCreated {
    if (json == null) {
        return json;
    }
    return {
        ...
        'props': CouponCreatedEffectPropsFromJSON(json['props']),
    };
}

export function EffectCouponCreatedToJSON(json: any): EffectCouponCreated {
    return EffectCouponCreatedToJSONTyped(json, false);
}

export function EffectCouponCreatedToJSONTyped(value?: EffectCouponCreated | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'props': CouponCreatedEffectPropsToJSON(value['props']),
    };
}
