...
import {
    ...
    RemoveFromAudienceEffectPropsToJSONTyped,
} from './RemoveFromAudienceEffectProps';

/**
 * 
 * @export
 * @interface EffectRemoveFromAudience
 */
export interface EffectRemoveFromAudience {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `removeFromAudience`.
     */
    effectType: EffectRemoveFromAudienceEffectTypeEnum;
    /**
    ...
    rewardId?: number;
    /**
     * The properties of the `removeFromAudience` effect.
     */
    props: RemoveFromAudienceEffectProps;
}
 ...
 * @export
 */
export const EffectRemoveFromAudienceEffectTypeEnum = {
    RemoveFromAudience: 'removeFromAudience',
} as const;
export type EffectRemoveFromAudienceEffectTypeEnum = typeof EffectRemoveFromAudienceEffectTypeEnum[keyof typeof EffectRemoveFromAudienceEffectTypeEnum];


/**
 * Check if a given object implements the EffectRemoveFromAudience interface.
 */
export function instanceOfEffectRemoveFromAudience(value: object): value is EffectRemoveFromAudience {
    ...
    if (_v['effectType'] !== 'removeFromAudience') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectRemoveFromAudienceFromJSON(json: any): EffectRemoveFromAudience {
    return EffectRemoveFromAudienceFromJSONTyped(json, false);
}

export function EffectRemoveFromAudienceFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectRemoveFromAudience {
    if (json == null) {
        return json;
    }
    return {
        ...
        'props': RemoveFromAudienceEffectPropsFromJSON(json['props']),
    };
}

export function EffectRemoveFromAudienceToJSON(json: any): EffectRemoveFromAudience {
    return EffectRemoveFromAudienceToJSONTyped(json, false);
}

export function EffectRemoveFromAudienceToJSONTyped(value?: EffectRemoveFromAudience | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'props': RemoveFromAudienceEffectPropsToJSON(value['props']),
    };
}
