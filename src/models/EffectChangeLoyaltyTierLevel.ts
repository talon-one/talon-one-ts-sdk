...
import {
    ...
    ChangeLoyaltyTierLevelEffectPropsToJSONTyped,
} from './ChangeLoyaltyTierLevelEffectProps';

/**
 * 
 * @export
 * @interface EffectChangeLoyaltyTierLevel
 */
export interface EffectChangeLoyaltyTierLevel {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `changeLoyaltyTierLevel`.
     */
    effectType: EffectChangeLoyaltyTierLevelEffectTypeEnum;
    /**
    ...
    rewardId?: number;
    /**
     * The properties of the `changeLoyaltyTierLevel` effect.
     */
    props: ChangeLoyaltyTierLevelEffectProps;
}
 ...
 * @export
 */
export const EffectChangeLoyaltyTierLevelEffectTypeEnum = {
    ChangeLoyaltyTierLevel: 'changeLoyaltyTierLevel',
} as const;
export type EffectChangeLoyaltyTierLevelEffectTypeEnum = typeof EffectChangeLoyaltyTierLevelEffectTypeEnum[keyof typeof EffectChangeLoyaltyTierLevelEffectTypeEnum];


/**
 * Check if a given object implements the EffectChangeLoyaltyTierLevel interface.
 */
export function instanceOfEffectChangeLoyaltyTierLevel(value: object): value is EffectChangeLoyaltyTierLevel {
    ...
    if (_v['effectType'] !== 'changeLoyaltyTierLevel') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectChangeLoyaltyTierLevelFromJSON(json: any): EffectChangeLoyaltyTierLevel {
    return EffectChangeLoyaltyTierLevelFromJSONTyped(json, false);
}

export function EffectChangeLoyaltyTierLevelFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectChangeLoyaltyTierLevel {
    if (json == null) {
        return json;
    }
    return {
        ...
        'props': ChangeLoyaltyTierLevelEffectPropsFromJSON(json['props']),
    };
}

export function EffectChangeLoyaltyTierLevelToJSON(json: any): EffectChangeLoyaltyTierLevel {
    return EffectChangeLoyaltyTierLevelToJSONTyped(json, false);
}

export function EffectChangeLoyaltyTierLevelToJSONTyped(value?: EffectChangeLoyaltyTierLevel | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'props': ChangeLoyaltyTierLevelEffectPropsToJSON(value['props']),
    };
}
