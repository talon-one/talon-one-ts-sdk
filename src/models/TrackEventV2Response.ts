 ...
 * 
 * @export
 * @interface TrackEventV2Response
 */
export interface TrackEventV2Response {
    /**
     * 
     * @type {CustomerProfile}
     * @memberof TrackEventV2Response
     */
...
/**
 * Check if a given object implements the TrackEventV2Response interface.
 */
export function instanceOfTrackEventV2Response(value: object): value is TrackEventV2Response {
...
export function TrackEventV2ResponseFromJSON(json: any): TrackEventV2Response {
    return TrackEventV2ResponseFromJSONTyped(json, false);
}

export function TrackEventV2ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TrackEventV2Response {
    if (json == null) {
        return json;
    }
    return {
...
export function TrackEventV2ResponseToJSON(json: any): TrackEventV2Response {
    return TrackEventV2ResponseToJSONTyped(json, false);
}

export function TrackEventV2ResponseToJSONTyped(value?: TrackEventV2Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
