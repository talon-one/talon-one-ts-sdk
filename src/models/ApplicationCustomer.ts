...
/**
 * Check if a given object implements the ApplicationCustomer interface.
 */
export function instanceOfApplicationCustomer(value: object): value is ApplicationCustomer {
...
export function ApplicationCustomerFromJSON(json: any): ApplicationCustomer {
    return ApplicationCustomerFromJSONTyped(json, false);
}

export function ApplicationCustomerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApplicationCustomer {
    if (json == null) {
        return json;
    }
    return {
...
export function ApplicationCustomerToJSON(json: any): ApplicationCustomer {
    return ApplicationCustomerToJSONTyped(json, false);
}

export function ApplicationCustomerToJSONTyped(value?: ApplicationCustomer | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
