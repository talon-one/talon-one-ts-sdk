...
import {
    ...
    RejectReferralEffectPropsToJSONTyped,
} from './RejectReferralEffectProps';

/**
 * 
 * @export
 * @interface EffectRejectReferral
 */
export interface EffectRejectReferral {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `rejectReferral`.
     */
    effectType: EffectRejectReferralEffectTypeEnum;
    /**
    ...
    rewardId?: number;
    /**
     * The properties of the `rejectReferral` effect.
     */
    props: RejectReferralEffectProps;
}
 ...
 * @export
 */
export const EffectRejectReferralEffectTypeEnum = {
    RejectReferral: 'rejectReferral',
} as const;
export type EffectRejectReferralEffectTypeEnum = typeof EffectRejectReferralEffectTypeEnum[keyof typeof EffectRejectReferralEffectTypeEnum];


/**
 * Check if a given object implements the EffectRejectReferral interface.
 */
export function instanceOfEffectRejectReferral(value: object): value is EffectRejectReferral {
    ...
    if (_v['effectType'] !== 'rejectReferral') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectRejectReferralFromJSON(json: any): EffectRejectReferral {
    return EffectRejectReferralFromJSONTyped(json, false);
}

export function EffectRejectReferralFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectRejectReferral {
    if (json == null) {
        return json;
    }
    return {
        ...
        'props': RejectReferralEffectPropsFromJSON(json['props']),
    };
}

export function EffectRejectReferralToJSON(json: any): EffectRejectReferral {
    return EffectRejectReferralToJSONTyped(json, false);
}

export function EffectRejectReferralToJSONTyped(value?: EffectRejectReferral | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'props': RejectReferralEffectPropsToJSON(value['props']),
    };
}
