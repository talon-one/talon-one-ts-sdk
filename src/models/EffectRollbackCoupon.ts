...
import {
    ...
    RollbackCouponEffectPropsToJSONTyped,
} from './RollbackCouponEffectProps';

/**
 * 
 * @export
 * @interface EffectRollbackCoupon
 */
export interface EffectRollbackCoupon {
    /**
     ...
     */
    effectType: EffectRollbackCouponEffectTypeEnum;
    /**
     ...
     */
    props: RollbackCouponEffectProps;
}
 ...
 * @export
 */
export const EffectRollbackCouponEffectTypeEnum = {
    RollbackCoupon: 'rollbackCoupon',
} as const;
export type EffectRollbackCouponEffectTypeEnum = typeof EffectRollbackCouponEffectTypeEnum[keyof typeof EffectRollbackCouponEffectTypeEnum];


/**
 * Check if a given object implements the EffectRollbackCoupon interface.
 */
export function instanceOfEffectRollbackCoupon(value: object): value is EffectRollbackCoupon {
    ...
    if (_v['effectType'] !== 'rollbackCoupon') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectRollbackCouponFromJSON(json: any): EffectRollbackCoupon {
    return EffectRollbackCouponFromJSONTyped(json, false);
}

export function EffectRollbackCouponFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectRollbackCoupon {
    if (json == null) {
        return json;
    }
    return {
        ...
        'props': RollbackCouponEffectPropsFromJSON(json['props']),
    };
}

export function EffectRollbackCouponToJSON(json: any): EffectRollbackCoupon {
    return EffectRollbackCouponToJSONTyped(json, false);
}

export function EffectRollbackCouponToJSONTyped(value?: EffectRollbackCoupon | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'props': RollbackCouponEffectPropsToJSON(value['props']),
    };
}
