...
import {
    ...
    ShowNotificationEffectPropsToJSONTyped,
} from './ShowNotificationEffectProps';

/**
 * 
 * @export
 * @interface EffectShowNotification
 */
export interface EffectShowNotification {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `showNotification`.
     */
    effectType: EffectShowNotificationEffectTypeEnum;
    /**
    ...
    rewardId?: number;
    /**
     * The properties of the `showNotification` effect.
     */
    props: ShowNotificationEffectProps;
}
 ...
 * @export
 */
export const EffectShowNotificationEffectTypeEnum = {
    ShowNotification: 'showNotification',
} as const;
export type EffectShowNotificationEffectTypeEnum = typeof EffectShowNotificationEffectTypeEnum[keyof typeof EffectShowNotificationEffectTypeEnum];


/**
 * Check if a given object implements the EffectShowNotification interface.
 */
export function instanceOfEffectShowNotification(value: object): value is EffectShowNotification {
    ...
    if (_v['effectType'] !== 'showNotification') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectShowNotificationFromJSON(json: any): EffectShowNotification {
    return EffectShowNotificationFromJSONTyped(json, false);
}

export function EffectShowNotificationFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectShowNotification {
    if (json == null) {
        return json;
    }
    return {
        ...
        'props': ShowNotificationEffectPropsFromJSON(json['props']),
    };
}

export function EffectShowNotificationToJSON(json: any): EffectShowNotification {
    return EffectShowNotificationToJSONTyped(json, false);
}

export function EffectShowNotificationToJSONTyped(value?: EffectShowNotification | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'props': ShowNotificationEffectPropsToJSON(value['props']),
    };
}
