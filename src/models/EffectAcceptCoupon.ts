...
import {
    ...
    AcceptCouponEffectPropsToJSONTyped,
} from './AcceptCouponEffectProps';

/**
 * 
 * @export
 * @interface EffectAcceptCoupon
 */
export interface EffectAcceptCoupon {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `acceptCoupon`.
     */
    effectType: EffectAcceptCouponEffectTypeEnum;
    /**
    ...
    rewardId?: number;
    /**
     * The properties of the `acceptCoupon` effect.
     */
    props: AcceptCouponEffectProps;
}
 ...
 * @export
 */
export const EffectAcceptCouponEffectTypeEnum = {
    AcceptCoupon: 'acceptCoupon',
} as const;
export type EffectAcceptCouponEffectTypeEnum = typeof EffectAcceptCouponEffectTypeEnum[keyof typeof EffectAcceptCouponEffectTypeEnum];


/**
 * Check if a given object implements the EffectAcceptCoupon interface.
 */
export function instanceOfEffectAcceptCoupon(value: object): value is EffectAcceptCoupon {
    ...
    if (_v['effectType'] !== 'acceptCoupon') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectAcceptCouponFromJSON(json: any): EffectAcceptCoupon {
    return EffectAcceptCouponFromJSONTyped(json, false);
}

export function EffectAcceptCouponFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectAcceptCoupon {
    if (json == null) {
        return json;
    }
    return {
        ...
        'props': AcceptCouponEffectPropsFromJSON(json['props']),
    };
}

export function EffectAcceptCouponToJSON(json: any): EffectAcceptCoupon {
    return EffectAcceptCouponToJSONTyped(json, false);
}

export function EffectAcceptCouponToJSONTyped(value?: EffectAcceptCoupon | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'props': AcceptCouponEffectPropsToJSON(value['props']),
    };
}
