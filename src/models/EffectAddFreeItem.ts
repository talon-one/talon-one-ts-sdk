...
import {
    ...
    AddFreeItemEffectPropsToJSONTyped,
} from './AddFreeItemEffectProps';

/**
 * 
 * @export
 * @interface EffectAddFreeItem
 */
export interface EffectAddFreeItem {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `addFreeItem`.
     */
    effectType: EffectAddFreeItemEffectTypeEnum;
    /**
    ...
    rewardId?: number;
    /**
     * The properties of the `addFreeItem` effect.
     */
    props: AddFreeItemEffectProps;
}
 ...
 * @export
 */
export const EffectAddFreeItemEffectTypeEnum = {
    AddFreeItem: 'addFreeItem',
} as const;
export type EffectAddFreeItemEffectTypeEnum = typeof EffectAddFreeItemEffectTypeEnum[keyof typeof EffectAddFreeItemEffectTypeEnum];


/**
 * Check if a given object implements the EffectAddFreeItem interface.
 */
export function instanceOfEffectAddFreeItem(value: object): value is EffectAddFreeItem {
    ...
    if (_v['effectType'] !== 'addFreeItem') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectAddFreeItemFromJSON(json: any): EffectAddFreeItem {
    return EffectAddFreeItemFromJSONTyped(json, false);
}

export function EffectAddFreeItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectAddFreeItem {
    if (json == null) {
        return json;
    }
    return {
        ...
        'props': AddFreeItemEffectPropsFromJSON(json['props']),
    };
}

export function EffectAddFreeItemToJSON(json: any): EffectAddFreeItem {
    return EffectAddFreeItemToJSONTyped(json, false);
}

export function EffectAddFreeItemToJSONTyped(value?: EffectAddFreeItem | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'props': AddFreeItemEffectPropsToJSON(value['props']),
    };
}
