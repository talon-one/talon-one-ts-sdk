...
export function UpdateCollectionToJSON(json: any): UpdateCollection {
    return UpdateCollectionToJSONTyped(json, false);
}

export function UpdateCollectionToJSONTyped(value?: UpdateCollection | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
