...
export interface AchievementBase {
     ...
     * 
     * @type {AchievementBaseRecurrencePolicyEnum}
     * @memberof AchievementBase
     */
    recurrencePolicy?: AchievementBaseRecurrencePolicyEnum;
    /**
     ...
     * 
     * @type {AchievementBaseActivationPolicyEnum}
     * @memberof AchievementBase
     */
    activationPolicy?: AchievementBaseActivationPolicyEnum;
    /**
 ...
 * @export
 */
export const AchievementBaseRecurrencePolicyEnum = {
    NoRecurrence: 'no_recurrence',
    OnExpiration: 'on_expiration',
    OnCompletion: 'on_completion'
} as const;
export type AchievementBaseRecurrencePolicyEnum = typeof AchievementBaseRecurrencePolicyEnum[keyof typeof AchievementBaseRecurrencePolicyEnum];

/**
 * @export
 */
export const AchievementBaseActivationPolicyEnum = {
    UserAction: 'user_action',
    FixedSchedule: 'fixed_schedule'
} as const;
export type AchievementBaseActivationPolicyEnum = typeof AchievementBaseActivationPolicyEnum[keyof typeof AchievementBaseActivationPolicyEnum];


/**
 * Check if a given object implements the AchievementBase interface.
 */
export function instanceOfAchievementBase(value: object): value is AchievementBase {
    const _v = value as Record<PropertyKey, unknown>;
    return true;
}

export function AchievementBaseFromJSON(json: any): AchievementBase {
    return AchievementBaseFromJSONTyped(json, false);
}

export function AchievementBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AchievementBase {
    if (json == null) {
        return json;
    }
    return {
...
export function AchievementBaseToJSON(json: any): AchievementBase {
    return AchievementBaseToJSONTyped(json, false);
}

export function AchievementBaseToJSONTyped(value?: AchievementBase | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
