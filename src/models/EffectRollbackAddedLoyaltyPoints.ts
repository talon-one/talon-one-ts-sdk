...
import {
    ...
    RollbackAddedLoyaltyPointsEffectPropsToJSONTyped,
} from './RollbackAddedLoyaltyPointsEffectProps';

/**
 * 
 * @export
 * @interface EffectRollbackAddedLoyaltyPoints
 */
export interface EffectRollbackAddedLoyaltyPoints {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `rollbackAddedLoyaltyPoints`.
     */
    effectType: EffectRollbackAddedLoyaltyPointsEffectTypeEnum;
    /**
    ...
    rewardId?: number;
    /**
     * The properties of the `rollbackAddedLoyaltyPoints` effect.
     */
    props: RollbackAddedLoyaltyPointsEffectProps;
}
 ...
 * @export
 */
export const EffectRollbackAddedLoyaltyPointsEffectTypeEnum = {
    RollbackAddedLoyaltyPoints: 'rollbackAddedLoyaltyPoints',
} as const;
export type EffectRollbackAddedLoyaltyPointsEffectTypeEnum = typeof EffectRollbackAddedLoyaltyPointsEffectTypeEnum[keyof typeof EffectRollbackAddedLoyaltyPointsEffectTypeEnum];


/**
 * Check if a given object implements the EffectRollbackAddedLoyaltyPoints interface.
 */
export function instanceOfEffectRollbackAddedLoyaltyPoints(value: object): value is EffectRollbackAddedLoyaltyPoints {
    ...
    if (_v['effectType'] !== 'rollbackAddedLoyaltyPoints') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectRollbackAddedLoyaltyPointsFromJSON(json: any): EffectRollbackAddedLoyaltyPoints {
    return EffectRollbackAddedLoyaltyPointsFromJSONTyped(json, false);
}

export function EffectRollbackAddedLoyaltyPointsFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectRollbackAddedLoyaltyPoints {
    if (json == null) {
        return json;
    }
    return {
        ...
        'props': RollbackAddedLoyaltyPointsEffectPropsFromJSON(json['props']),
    };
}

export function EffectRollbackAddedLoyaltyPointsToJSON(json: any): EffectRollbackAddedLoyaltyPoints {
    return EffectRollbackAddedLoyaltyPointsToJSONTyped(json, false);
}

export function EffectRollbackAddedLoyaltyPointsToJSONTyped(value?: EffectRollbackAddedLoyaltyPoints | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'props': RollbackAddedLoyaltyPointsEffectPropsToJSON(value['props']),
    };
}
