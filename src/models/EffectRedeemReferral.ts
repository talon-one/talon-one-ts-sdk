...
import {
    ...
    RedeemReferralEffectPropsToJSONTyped,
} from './RedeemReferralEffectProps';

/**
 * 
 * @export
 * @interface EffectRedeemReferral
 */
export interface EffectRedeemReferral {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `redeemReferral`.
     */
    effectType: EffectRedeemReferralEffectTypeEnum;
    /**
     ...
     * @deprecated
     */
    props: RedeemReferralEffectProps;
}
 ...
 * @export
 */
export const EffectRedeemReferralEffectTypeEnum = {
    RedeemReferral: 'redeemReferral',
} as const;
export type EffectRedeemReferralEffectTypeEnum = typeof EffectRedeemReferralEffectTypeEnum[keyof typeof EffectRedeemReferralEffectTypeEnum];


/**
 * Check if a given object implements the EffectRedeemReferral interface.
 */
export function instanceOfEffectRedeemReferral(value: object): value is EffectRedeemReferral {
    ...
    if (_v['effectType'] !== 'redeemReferral') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectRedeemReferralFromJSON(json: any): EffectRedeemReferral {
    return EffectRedeemReferralFromJSONTyped(json, false);
}

export function EffectRedeemReferralFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectRedeemReferral {
    if (json == null) {
        return json;
    }
    return {
...
export function EffectRedeemReferralToJSON(json: any): EffectRedeemReferral {
    return EffectRedeemReferralToJSONTyped(json, false);
}

export function EffectRedeemReferralToJSONTyped(value?: EffectRedeemReferral | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
