...
import {
    ...
    WillAwardGiveawayEffectPropsToJSONTyped,
} from './WillAwardGiveawayEffectProps';

/**
 * 
 * @export
 * @interface EffectWillAwardGiveaway
 */
export interface EffectWillAwardGiveaway {
    /**
     ...
     */
    effectType: EffectWillAwardGiveawayEffectTypeEnum;
    /**
 ...
 * @export
 */
export const EffectWillAwardGiveawayEffectTypeEnum = {
    WillAwardGiveaway: 'willAwardGiveaway',
} as const;
export type EffectWillAwardGiveawayEffectTypeEnum = typeof EffectWillAwardGiveawayEffectTypeEnum[keyof typeof EffectWillAwardGiveawayEffectTypeEnum];


/**
 * Check if a given object implements the EffectWillAwardGiveaway interface.
 */
export function instanceOfEffectWillAwardGiveaway(value: object): value is EffectWillAwardGiveaway {
    ...
    if (_v['effectType'] !== 'willAwardGiveaway') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectWillAwardGiveawayFromJSON(json: any): EffectWillAwardGiveaway {
    return EffectWillAwardGiveawayFromJSONTyped(json, false);
}

export function EffectWillAwardGiveawayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectWillAwardGiveaway {
    if (json == null) {
        return json;
    }
    return {
...
export function EffectWillAwardGiveawayToJSON(json: any): EffectWillAwardGiveaway {
    return EffectWillAwardGiveawayToJSONTyped(json, false);
}

export function EffectWillAwardGiveawayToJSONTyped(value?: EffectWillAwardGiveaway | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
