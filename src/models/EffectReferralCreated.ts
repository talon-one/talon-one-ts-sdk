...
import {
    ...
    ReferralCreatedEffectPropsToJSONTyped,
} from './ReferralCreatedEffectProps';

/**
 * 
 * @export
 * @interface EffectReferralCreated
 */
export interface EffectReferralCreated {
    /**
    ...
    ruleName: string;
    /**
     * An effect discriminator of type `referralCreated`.
     */
    effectType: EffectReferralCreatedEffectTypeEnum;
    /**
    ...
    rewardId?: number;
    /**
     * The properties of the `referralCreated` effect.
     */
    props: ReferralCreatedEffectProps;
}
 ...
 * @export
 */
export const EffectReferralCreatedEffectTypeEnum = {
    ReferralCreated: 'referralCreated',
} as const;
export type EffectReferralCreatedEffectTypeEnum = typeof EffectReferralCreatedEffectTypeEnum[keyof typeof EffectReferralCreatedEffectTypeEnum];


/**
 * Check if a given object implements the EffectReferralCreated interface.
 */
export function instanceOfEffectReferralCreated(value: object): value is EffectReferralCreated {
    ...
    if (_v['effectType'] !== 'referralCreated') return false;
    
    if (!('props' in _v) || _v['props'] === undefined) return false;
    return true;
}

export function EffectReferralCreatedFromJSON(json: any): EffectReferralCreated {
    return EffectReferralCreatedFromJSONTyped(json, false);
}

export function EffectReferralCreatedFromJSONTyped(json: any, ignoreDiscriminator: boolean): EffectReferralCreated {
    if (json == null) {
        return json;
    }
    return {
        ...
        'props': ReferralCreatedEffectPropsFromJSON(json['props']),
    };
}

export function EffectReferralCreatedToJSON(json: any): EffectReferralCreated {
    return EffectReferralCreatedToJSONTyped(json, false);
}

export function EffectReferralCreatedToJSONTyped(value?: EffectReferralCreated | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'props': ReferralCreatedEffectPropsToJSON(value['props']),
    };
}
